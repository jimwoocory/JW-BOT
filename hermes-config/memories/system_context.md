...
Hermes Agent（自主开发与自我完善）
    ↓
JW-Bot 代码库 /Users/dianchi/JW-Bot/
```
...
- 路径：`/Users/dianchi/JW-Bot/data/plugins/dreamina_plugin/main.py`
- 能力：文生图、文生视频、图片转视频
...
### marketing_tools
- 路径：`/Users/dianchi/JW-Bot/astrbot/plugins/marketing_tools/main.py`
...
### hermes_bridge
- 路径：`/Users/dianchi/JW-Bot/astrbot/plugins/hermes_bridge/`
- Hermes webhook：`http://localhost:8644/webhooks/astrbot_qq`
- 回调端口：8645

## Harness 系统现状

- **路径**：`/Users/dianchi/JW-Bot/astrbot/core/harness/`
...
- **开发计划**：`/Users/dianchi/JW-Bot/harness-engineering-phase1-plan.md`

## 关键路径

| 资源 | 路径 |
|------|------|
| AstrBot 主目录 | `/Users/dianchi/JW-Bot/` |
| AstrBot 运行日志 | `/Users/dianchi/JW-Bot/astrbot.log` |
| AstrBot 错误日志 | `/Users/dianchi/JW-Bot/astrbot.err.log` |
| Hermes workspace | `/Users/dianchi/JW-Bot/hermes-workspace/` |
| Hermes 配置 | `/Users/dianchi/JW-Bot/hermes-config/` |
| AstrBot 数据库 | `/Users/dianchi/JW-Bot/data/data_v4.db` |
| Harness 数据库 | `/Users/dianchi/JW-Bot/data/harness.db` |
| 启动 AstrBot | `cd /Users/dianchi/JW-Bot && ./.venv/bin/python main.py` |

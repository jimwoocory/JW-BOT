...
### 1.1 AstrBot 系统
**主文件**: `/Users/dianchi/DC-Agent/main.py`  
...
### 1.2 Hermes Agent 系统
**安装位置**: `/Users/dianchi/DC-Agent/hermes-agent-temp`  
...
**位置**: `/Users/dianchi/DC-Agent/astrbot/plugins/hermes_bridge/__init__.py`
...
#### 会话映射持久化：
```python
session_mapping_file = "/Users/dianchi/DC-Agent/data/config/hermes_bridge_sessions.json"
...
文件：`/Users/dianchi/DC-Agent/hermes-workspace/skills/query_kb.py`

...
from jw_harness.core_v2.async_tasks import AsyncJobStatus, AsyncTaskService
from jw_harness.core_v2.dashboard_api import DashboardAPIService
from jw_harness.core_v2.engine import HarnessEngine
from jw_harness.core_v2.inspection_replay import InspectionReplayService
from jw_harness.core_v2.memory_store import MemoryStore
from jw_harness.core_v2.memory_compressor import MemoryCompressor
from jw_harness.core_v2.memory_promotion import MemoryPromotionPolicy
from jw_harness.core_v2.notifications import NotificationCenter
from jw_harness.core_v2.operational_queries import OperationalQueryService
from jw_harness.core_v2.queryable_store import QueryableStore
from jw_harness.core_v2.replay import ReplayManager
from jw_harness.core_v2.short_term_memory import ShortTermMemoryManager
from jw_harness.core_v2.scheduled_tasks import ScheduleStatus, ScheduledTaskService
from jw_harness.core_v2.schemas.result import Result, ResultType
from jw_harness.core_v2.task_api import TaskAPIService
from jw_harness.core_v2.backend_adapters import OpenClawBackendAdapter
from .flags import (
...
class HarnessAstrBotBridge:
    ...
    def __init__(self, engine: HarnessEngine | None = None):
        ...
        self.backend_adapter = OpenClawBackendAdapter()
        self.query_service = OperationalQueryService(
            task_store=self.engine.task_store,
            memory_store=self.memory_store,
            project_keywords=self.PROJECT_KEYWORDS,
            backend_memory_port=self.backend_adapter,
            backend_task_port=self.backend_adapter,
        )
